...
export default function PredictPage() {
  ...
  return (
    <>
      ...
      {/* Navigation */}
      <nav className="relative z-[100] px-4 md:px-8 py-4 backdrop-blur-xl bg-background/80 border-b border-card-border/50">
        <div className="max-w-[1200px] mx-auto flex items-center justify-between">
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 px-4 py-2 text-foreground-muted no-underline text-sm font-medium rounded-lg transition-all duration-200 hover:text-foreground hover:bg-white/5 group"
          >
            <svg
              width="16"
              height="16"
      ...
      <main className="relative z-[1] max-w-[1200px] mx-auto px-4 md:px-8 py-12">
        ...
        >
          ...
          <p className="text-foreground-muted text-lg">
            Enter your agricultural parameters to get an AI-powered yield
            estimate
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          {/* Input Form Card */}
          <div
            className="bg-card-solid backdrop-blur-xl border border-card-border rounded-3xl p-6 md:p-8 relative overflow-hidden animate-fadeInUp"
          >
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                <FormField label="Region / Area" delay={100}>
                  <select
                    name="area"
                    value={formData.area}
                ...
                <FormField label="Crop Type" delay={150}>
                  <select
                    name="item"
                    value={formData.item}
                    onChange={handleInputChange}
                ...
                <FormField label="Year" delay={200}>
                  <input
                    type="number"
                    name="year"
                    value={formData.year}
                ...
                <FormField label="Avg Rainfall (mm/year)" delay={250}>
                  <input
                    type="number"
                    name="rainfall"
                ...
                <FormField label="Pesticides (tonnes)" delay={300}>
                  <input
                    type="number"
                    name="pesticides"
                ...
                <FormField label="Avg Temperature (C)" delay={350}>
                  <input
                    type="number"
                    name="avg_temp"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full mt-6 px-8 py-4 bg-gradient-to-r from-primary to-primary-dark text-white border-none rounded-[14px] text-base font-semibold cursor-pointer flex items-center justify-center gap-3 transition-all duration-300 hover:shadow-[0_15px_35px_rgba(34,197,94,0.35)] hover:-translate-y-0.5 disabled:opacity-70 disabled:cursor-not-allowed disabled:hover:transform-none"
                style={{ animation: "formReveal 0.4s ease 0.4s forwards", opacity: 0 }}
              >
                {isLoading ? (
                  <>
                    <svg
          ...
          {/* Result Card */}
          <div
            className="bg-card-solid backdrop-blur-xl border border-card-border rounded-3xl p-6 md:p-8 min-h-[480px] flex flex-col items-center justify-center text-center relative overflow-hidden animate-fadeInUp"
          ...
          >
            ...
            {!result ? (
              <div className="text-foreground-muted">
                <div className="w-20 h-20 mx-auto mb-6 bg-primary/10 rounded-[20px] flex items-center justify-center">
                  <svg
              ...
              <div className="w-full animate-scaleIn">
                <div className="w-[72px] h-[72px] mx-auto mb-6 bg-gradient-to-br from-primary/20 to-primary/5 rounded-[20px] flex items-center justify-center">
                  <svg
                ...
                <div className="text-sm text-foreground-muted font-medium mb-2">
                  Predicted Yield
                </div>
                <div className="text-5xl md:text-6xl font-extrabold text-primary leading-none mb-2">
                  {result.prediction.toLocaleString()}
                </div>
                <div className="text-base text-foreground-muted mb-8">
...
function FormField({
  ...
  return (
    <div
      ...
      style={{
        animation: `formReveal 0.4s ease ${delay}ms forwards`,
        opacity: 0,
